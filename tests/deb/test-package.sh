...
#
# Examples:
#   ./tests/deb/test-package.sh artifacts/release/ci-tools_0.0.0_amd64.deb
#   ./tests/deb/test-package.sh artifacts/release/ci-tools_0.0.0_amd64.deb debian:bookworm-slim
#   ./tests/deb/test-package.sh artifacts/release/ci-tools_0.0.0_amd64.deb ubuntu:24.04
#
# Requirements:
...
if [[ $# -lt 1 ]]; then
  ...
  echo ""
  echo "Examples:"
  echo "  $0 artifacts/release/ci-tools_0.0.0_amd64.deb"
  echo "  $0 artifacts/release/ci-tools_0.0.0_amd64.deb ubuntu:24.04"
  exit 1
fi
